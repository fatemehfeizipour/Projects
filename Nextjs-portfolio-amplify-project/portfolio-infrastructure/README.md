...
Infrastructure as Code (AWS CDK, TypeScript) that provisions AWS Amplify Hosting for the [`my-portfolio`](https://main.d27jisummbpcj6.amplifyapp.com/) Next.js application.
